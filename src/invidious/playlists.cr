  ...
  def to_xml(xml : XML::Builder)
    xml.element("entry") do
      ...
      xml.element("content", type: "xhtml") do
        xml.element("div", xmlns: "http://www.w3.org/1999/xhtml") do
          xml.element("a", href: "#{HOST_URL}/watch?v=#{self.id}") do
            xml.element("img", src: "https://proxy.invidio.xamh.de/vi/#{self.id}/mqdefault.jpg?host=i.ytimg.com")
          end
        end
      end
      ...
      xml.element("media:group") do
        ...
        xml.element("media:thumbnail", url: "https://proxy.invidio.xamh.de/vi/#{self.id}/mqdefault.jpg?host=i.ytimg.com",
...
struct InvidiousPlaylist
  ...
  def thumbnail
    ...
    "https://proxy.invidio.xamh.de/vi/#{@thumbnail_id}/mqdefault.jpg?host=i.ytimg.com"
  end
    ...
    html += <<-END_HTML
      <li class="pure-menu-item" id="#{video["videoId"]}">
        <a href="/watch?v=#{video["videoId"]}&list=#{playlist["playlistId"]}&index=#{video["index"]}">
          <div class="thumbnail">
              <img loading="lazy" class="thumbnail" src="https://proxy.invidio.xamh.de/vi/#{video["videoId"]}/mqdefault.jpg?host=i.ytimg.com">
